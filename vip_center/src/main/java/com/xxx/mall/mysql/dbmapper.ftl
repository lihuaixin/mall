...
<mapper namespace="${packageName}.${moduleName}.mapper.${ClassName}Mapper">
    <!--返回Map-->        
    <resultMap id="BaseResultMap" type="${packageName}.${moduleName}.domain.${ClassName}Do">
    <#list list as column>
    ...
    <insert id="save" parameterType="${packageName}.${moduleName}.domain.${ClassName}Do">
    ...
    <insert id="saveSelective"  parameterType="${packageName}.${moduleName}.domain.${ClassName}Do">
        ...
        values
            ...
            <#else>
                <if test="${column.columnName} != null and ${column.columnName} != ''">
                     #${leftBraces}${column.columnName},jdbcType=${column.jdbcType}${rightBraces}<#if column_index+1 != listSize>,<#else></#if>
                </if>
            </#if>
            </#list>
            </trim>)
    ...
    <update id="update" parameterType="${packageName}.${moduleName}.domain.${ClassName}Do">
        update ${tableName} set
         <#list list as column>
            <#if column.columnName == "id" || column.columnName == "addTime">
            <#else >
